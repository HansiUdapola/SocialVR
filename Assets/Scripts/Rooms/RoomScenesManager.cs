...
public class RoomScenesManager : MonoBehaviour
{
    ...
    private void OnJoinedRoom(IRoom room)
    {
        ...
        if(name == null)
        {
            UpdateRoomScene(); // if we've joined a room without a set scene
        }
    }
    ...
    private static RoomScenesManager FindSceneManager(NetworkScene scene)
    {
        var manager = scene.GetComponentInChildren<RoomScenesManager>();
